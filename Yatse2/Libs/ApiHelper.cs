...
namespace Yatse2.Libs
{
    ...
    public class ApiHelper
    {
        ...
        public void LoadRemotePlugins(int yatseVersion)
        {
            ...
            {
                var args = plugin;
                Logger.Instance().Log("Yatse2-Plugs", "Loading : " + plugin, true);
                try
                {
                    ...
                    if (asm != null)
                    {
                        foreach (var t in asm.GetTypes())
                        {
                            ...
                            Logger.Instance().Log("Yatse2-Plugs", "Plugin : " + plug.Name + " (Version : " + plug.Version + ")", true);
                            if (!plug.IsCompatible(yatseVersion))
                            {
                                Logger.Instance().Log("Yatse2-Plugs",
                ...
                {
                    Logger.Instance().Log("Yatse2-Plugs", "Plugin : " + plugin + " refused to load.",true);
