...
namespace Yatse2.Classes
{
    ...
    DependencyProperty.Register("Day1MinTemp", typeof(string), typeof(Yatse2Weather));
        ...
        public void LoadForecastData(WeatherData data, string skin)
        {
            ...
            Day0Name = DateTime.Now.AddDays(data.Forecast[0].DayDiff).ToString("dddd", CultureInfo.CurrentUICulture.DateTimeFormat).ToUpperInvariant();
            ...
            Day1Name = DateTime.Now.AddDays(data.Forecast[1].DayDiff).ToString("dddd", CultureInfo.CurrentUICulture.DateTimeFormat).ToUpperInvariant();
            ...
            Day2Name = DateTime.Now.AddDays(data.Forecast[2].DayDiff).ToString("dddd", CultureInfo.CurrentUICulture.DateTimeFormat).ToUpperInvariant();
            ...
            Day3Name = DateTime.Now.AddDays(data.Forecast[3].DayDiff).ToString("dddd", CultureInfo.CurrentUICulture.DateTimeFormat).ToUpperInvariant();
            ...
            Day4Name = DateTime.Now.AddDays(data.Forecast[4].DayDiff).ToString("dddd", CultureInfo.CurrentUICulture.DateTimeFormat).ToUpperInvariant();
