...
namespace Yatse2
{
    public partial class Yatse2Window
    {
        ...
        {
            Logger.Instance().Log("Yatse2", "Start Refresh : TvEpisodes");
            var res = _remote.VideoLibrary.GetTvEpisodes();
            Logger.Instance().Log("Yatse2", "Remote TvEpisodes : " + res.Count);
            ...
            _database.CommitTransaction();
            _database.SetBulkInsert(false);
            Logger.Instance().Log("Yatse2", "End Refresh : TvEpisodes");
        }
        ...
        {
            Logger.Instance().Log("Yatse2","Start Refresh : MusicArtists");
            var res = _remote.AudioLibrary.GetArtists();
            Logger.Instance().Log("Yatse2","Remote MusicArtists : " + res.Count);
            ...
            _database.CommitTransaction();
            _database.SetBulkInsert(false);
            Logger.Instance().Log("Yatse2","End Refresh : MusicArtists");
        }
        ...
        {
            Logger.Instance().Log("Yatse2","Start Refresh : Thumbs/Fanarts");
            ...
            Logger.Instance().Log("Yatse2", "Refresh : Thumbs/Fanarts : " + dlinfo.Count + " files");
            _remote.File.AsyncDownloadImages(dlinfo.ToArray());
            _remoteInfo.CacheFilled = 0;
            _database.UpdateRemote(_remoteInfo);
            Logger.Instance().Log("Yatse2", "End Refresh : Thumbs/Fanarts");
        ...
        private void RefreshLibrary()
        {
            ...
            Logger.Instance().Log("Yatse2", "Starting Library Refresh", true);
            ...
            Logger.Instance().Log("Yatse2", "End Library Refresh", true);
